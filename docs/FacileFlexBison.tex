...
{\color{incolor}In [{\color{incolor} }]:} \PY{k+kt}{int} \PY{n+nf}{yylex}\PY{p}{(}\PY{p}{)}\PY{p}{;}
        ...
        \PY{k+kt}{unsigned} \PY{k+kt}{int} \PY{n}{if\PYZus{}offset} \PY{o}{=} \PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{;} \PY{c+c1}{// +1 everytime}
        \PY{k+kt}{unsigned} \PY{k+kt}{int} \PY{n}{elseif\PYZus{}offset} \PY{o}{=} \PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{;} \PY{c+c1}{// +1 everytime}
        \PY{k+kt}{unsigned} \PY{k+kt}{int} \PY{n}{loop\PYZus{}offset} \PY{o}{=} \PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{;} \PY{c+c1}{// +1 when loop}
...
{\color{incolor}In [{\color{incolor} }]:} \PY{c+cm}{/* If statement */}
        \PY{k}{else} \PY{n+nf}{if}\PY{p}{(}\PY{n}{node}\PY{o}{\PYZhy{}}\PY{o}{\PYZgt{}}\PY{n}{data} \PY{o}{=}\PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{if}\PY{l+s}{\PYZdq{}}\PY{p}{)}\PY{p}{\PYZob{}}
            \PY{n}{if\PYZus{}offset}\PY{o}{+}\PY{o}{+}\PY{p}{;}
            ...
            \PY{n}{guint} \PY{n}{endSbl} \PY{o}{=} \PY{n}{if\PYZus{}offset}\PY{p}{;}
            \PY{n}{fprintf}\PY{p}{(}\PY{n}{stream}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{    brfalse IF\PYZus{}\PYZpc{}d}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+se}{\PYZbs{}n}\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{endSbl}\PY{p}{)}\PY{p}{;}
            ...
            \PY{n}{fprintf}\PY{p}{(}\PY{n}{stream}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{    nop}\PY{l+s+se}{\PYZbs{}n}\PY{l+s}{\PYZdq{}}\PY{p}{)}\PY{p}{;}
            \PY{n}{fprintf}\PY{p}{(}\PY{n}{stream}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{    br IF\PYZus{}END\PYZus{}\PYZpc{}d}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+se}{\PYZbs{}n}\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{endSbl}\PY{p}{)}\PY{p}{;}
        
            \PY{n}{fprintf}\PY{p}{(}\PY{n}{stream}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{    IF\PYZus{}\PYZpc{}d: nop}\PY{l+s+se}{\PYZbs{}n}\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{endSbl}\PY{p}{)}\PY{p}{;} \PY{c+c1}{// end of code, mark jump point}
            ...
            \PY{n}{fprintf}\PY{p}{(}\PY{n}{stream}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{    IF\PYZus{}END\PYZus{}\PYZpc{}d: nop}\PY{l+s+se}{\PYZbs{}n}\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{endSbl}\PY{p}{)}\PY{p}{;}
        \PY{p}{\PYZcb{}}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor} }]:} \PY{c+cm}{/*ElseIf statement*/}
        \PY{k}{else} \PY{n+nf}{if}\PY{p}{(}\PY{n}{node}\PY{o}{\PYZhy{}}\PY{o}{\PYZgt{}}\PY{n}{data} \PY{o}{=}\PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{elseif}\PY{l+s}{\PYZdq{}}\PY{p}{)}\PY{p}{\PYZob{}}
            \PY{n}{elseif\PYZus{}offset}\PY{o}{+}\PY{o}{+}\PY{p}{;}
        
            \PY{n}{produce\PYZus{}code}\PY{p}{(}\PY{n}{g\PYZus{}node\PYZus{}nth\PYZus{}child}\PY{p}{(}\PY{n}{node}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{)}\PY{p}{)}\PY{p}{;} \PY{c+c1}{// boolean\PYZus{}expr}
        
            \PY{c+c1}{// Mark the jump address}
            \PY{n}{guint} \PY{n}{endSbl} \PY{o}{=} \PY{n}{elseif\PYZus{}offset}\PY{p}{;}
            \PY{n}{guint} \PY{n}{ifSbl} \PY{o}{=} \PY{n}{if\PYZus{}offset}\PY{p}{;}
        
            \PY{n}{fprintf}\PY{p}{(}\PY{n}{stream}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{    brfalse ELSEIF\PYZus{}\PYZpc{}d}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+se}{\PYZbs{}n}\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{endSbl}\PY{p}{)}\PY{p}{;}
            ...
            \PY{n}{fprintf}\PY{p}{(}\PY{n}{stream}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{    nop}\PY{l+s+se}{\PYZbs{}n}\PY{l+s}{\PYZdq{}}\PY{p}{)}\PY{p}{;}
            \PY{n}{fprintf}\PY{p}{(}\PY{n}{stream}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{    br IF\PYZus{}END\PYZus{}\PYZpc{}d}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+se}{\PYZbs{}n}\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{ifSbl}\PY{p}{)}\PY{p}{;}
        
            \PY{n}{fprintf}\PY{p}{(}\PY{n}{stream}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{    ELSEIF\PYZus{}\PYZpc{}d: nop}\PY{l+s+se}{\PYZbs{}n}\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{endSbl}\PY{p}{)}\PY{p}{;} \PY{c+c1}{// end of code, mark jump point}
            \PY{n}{produce\PYZus{}code}\PY{p}{(}\PY{n}{g\PYZus{}node\PYZus{}nth\PYZus{}child}\PY{p}{(}\PY{n}{node}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{)}\PY{p}{)}\PY{p}{;} \PY{c+c1}{// elseif}
        \PY{p}{\PYZcb{}}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor} }]:} \PY{c+cm}{/* Loop interuptor */}
        \PY{k}{else} \PY{n+nf}{if}\PY{p}{(}\PY{n}{node}\PY{o}{\PYZhy{}}\PY{o}{\PYZgt{}}\PY{n}{data} \PY{o}{=}\PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{skipItr}\PY{l+s}{\PYZdq{}}\PY{p}{)}\PY{p}{\PYZob{}}
            ...
            \PY{n}{fprintf}\PY{p}{(}\PY{n}{stream}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{   br LOOP\PYZus{}INCR\PYZus{}\PYZpc{}d}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+se}{\PYZbs{}n}\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{endSbl}\PY{p}{)}\PY{p}{;}
        \PY{p}{\PYZcb{}}
        ...
        \PY{k}{else} \PY{n+nf}{if}\PY{p}{(}\PY{n}{node}\PY{o}{\PYZhy{}}\PY{o}{\PYZgt{}}\PY{n}{data} \PY{o}{=}\PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{breakLoop}\PY{l+s}{\PYZdq{}}\PY{p}{)}\PY{p}{\PYZob{}}
            \PY{n}{guint} \PY{n}{endSbl} \PY{o}{=} \PY{n}{loop\PYZus{}offset}\PY{p}{;}
            \PY{n}{fprintf}\PY{p}{(}\PY{n}{stream}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{   br LOOP\PYZus{}END\PYZus{}\PYZpc{}d}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+se}{\PYZbs{}n}\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{endSbl}\PY{p}{)}\PY{p}{;}
        \PY{p}{\PYZcb{}}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor} }]:} \PY{c+cm}{/* While */}
        \PY{k}{else} \PY{n+nf}{if}\PY{p}{(}\PY{n}{node}\PY{o}{\PYZhy{}}\PY{o}{\PYZgt{}}\PY{n}{data} \PY{o}{=}\PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{while}\PY{l+s}{\PYZdq{}}\PY{p}{)}\PY{p}{\PYZob{}}
            ...
            \PY{c+c1}{// Branch out}
            \PY{n}{guint} \PY{n}{endSbl} \PY{o}{=} \PY{n}{loop\PYZus{}offset}\PY{p}{;}
            \PY{n}{fprintf}\PY{p}{(}\PY{n}{stream}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{   br LOOP\PYZus{}HEAD\PYZus{}\PYZpc{}d}\PY{l+s+se}{\PYZbs{}n}\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{endSbl}\PY{p}{)}\PY{p}{;} \PY{c+c1}{// Init first iteration by jumping}
        \PY{n}{to} \PY{n}{head}
            ...
            \PY{n}{produce\PYZus{}code}\PY{p}{(}\PY{n}{g\PYZus{}node\PYZus{}nth\PYZus{}child}\PY{p}{(}\PY{n}{node}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{)}\PY{p}{)}\PY{p}{;} \PY{c+c1}{// boolean\PYZus{}expr}
            \PY{n}{fprintf}\PY{p}{(}\PY{n}{stream}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{   brtrue LOOP\PYZus{}START\PYZus{}\PYZpc{}d}\PY{l+s+se}{\PYZbs{}n}\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{endSbl}\PY{p}{)}\PY{p}{;} \PY{c+c1}{// jump to beginning of loop}
        \PY{k}{if} \PY{n}{cond}
...
{\color{incolor}In [{\color{incolor} }]:} \PY{c+cm}{/* Foreach */}
        \PY{k}{else} \PY{n+nf}{if}\PY{p}{(}\PY{n}{node}\PY{o}{\PYZhy{}}\PY{o}{\PYZgt{}}\PY{n}{data} \PY{o}{=}\PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{foreach}\PY{l+s}{\PYZdq{}}\PY{p}{)}\PY{p}{\PYZob{}}
            ...
            \PY{n}{fprintf}\PY{p}{(}\PY{n}{stream}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{   stloc \PYZpc{}d}\PY{l+s+se}{\PYZbs{}n}\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{endSbl}\PY{p}{)}\PY{p}{;}
            ...
            \PY{n}{fprintf}\PY{p}{(}\PY{n}{stream}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{   nop}\PY{l+s+se}{\PYZbs{}n}\PY{l+s}{\PYZdq{}}\PY{p}{)}\PY{p}{;}
            \PY{n}{fprintf}\PY{p}{(}\PY{n}{stream}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{   ldloc \PYZpc{}d}\PY{l+s+se}{\PYZbs{}n}\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{endSbl}\PY{p}{)}\PY{p}{;}
            \PY{n}{fprintf}\PY{p}{(}\PY{n}{stream}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{   ldc.i4.1}\PY{l+s+se}{\PYZbs{}n}\PY{l+s}{\PYZdq{}}\PY{p}{)}\PY{p}{;}
            \PY{n}{fprintf}\PY{p}{(}\PY{n}{stream}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{   add}\PY{l+s+se}{\PYZbs{}n}\PY{l+s}{\PYZdq{}}\PY{p}{)}\PY{p}{;}
            \PY{n}{fprintf}\PY{p}{(}\PY{n}{stream}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{   stloc \PYZpc{}d}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+se}{\PYZbs{}n}\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{endSbl}\PY{p}{)}\PY{p}{;} \PY{c+c1}{// Unload counter}
        
            \PY{n}{fprintf}\PY{p}{(}\PY{n}{stream}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{   LOOP\PYZus{}HEAD\PYZus{}\PYZpc{}d: }\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{endSbl}\PY{p}{)}\PY{p}{;} \PY{c+c1}{// Mark head}
            \PY{n}{fprintf}\PY{p}{(}\PY{n}{stream}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{   ldloc \PYZpc{}d}\PY{l+s+se}{\PYZbs{}n}\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{endSbl}\PY{p}{)}\PY{p}{;} \PY{c+c1}{// Reload counter}
